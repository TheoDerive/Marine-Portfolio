...
export default function Diplomes() {
  const diplome1: DiplomeType = {
    ...
    description:
      "J'ai intégré **My Digital School** pour développer mes compétences en **marketing digital**, un domaine qui me passionne pour son pouvoir à transformer la **visibilité** et la **croissance des marques.** Cette formation m’a permis d’acquérir des compétences solides en marketing digital, me permettant de concevoir des **stratégies efficaces** et de mesurer leur impact avec des **outils modernes.** \n \n En parallèle, j’ai exploré la **communication**, développant des compétences en **création de contenu** et en élaboration de **stratégies alignées.** Cette expertise m’a sensibilisée à l’importance de l’alignement des messages et de la gestion de la **réputation de marque.** Grâce à cette **double compétence**, je suis désormais capable de coordonner efficacement des **projets digitaux**, en combinant **stratégie marketing** et **design graphique**, pour offrir des résultats **créatifs** et **performants**, tout en garantissant des **livrables de qualité.**",
  };
